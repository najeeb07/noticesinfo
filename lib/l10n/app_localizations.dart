...
abstract class AppLocalizations {
  ...
  /// No description provided for @contactFromApp.
  ///
  /// In en, this message translates to:
  /// **'Contact from Notices Info App'**
  String get contactFromApp;
  ...
  /// No description provided for @couldNotLaunchStore.
  ///
  /// In en, this message translates to:
  /// **'Could not launch store page.'**
  String get couldNotLaunchStore;
  ...
  ///
  /// In en, this message translates to:
  /// **'Check out this awesome app: https://play.google.com/store/apps/details?id=com.noticesinfo.app'**
  ...
  /// No description provided for @pleaseLoginToUpdateProfile.
  ///
  /// In en, this message translates to:
  /// **'Please log in to update your profile.'**
  String get pleaseLoginToUpdateProfile;
}
